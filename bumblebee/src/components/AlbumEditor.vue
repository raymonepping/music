...
export default {
  ...
  data() {
    return {
      albumData: [], // Store fetched albums here
      error: null,
      loading: false,
      currentPage: 1,
      pageSize: 6,
      totalPages: 1,
      defaultAlbumArt, // Add defaultAlbumArt to the component's data
  ...
  methods: {
    ...
    onImageError(event) {
      event.target.src = this.defaultAlbumArt; // Use the imported default image
    },
  },
};
</script>
