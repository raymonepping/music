<template>
  <div class="flex flex-col min-h-screen">
    ...
    <!-- Authentication Container with extra margin top -->
    <div
      class="authn-container mx-auto max-w-2xl py-6 px-8 bg-white shadow-lg rounded-lg mt-16"
    >
      ...
      <div v-if="isAuthenticated && currentUser" class="welcome-message">
        ...
        <!-- Logout Button -->
        <button class="logout-btn mt-4" @click="handleLogout">Logout</button>
      </div>
...
// import AppFooter from '../components/AppFooter.vue' // Renamed Footer to AppFooter
