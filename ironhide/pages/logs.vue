...
export default {
  ...
  methods: {
    ...
    selectContainer(container) {
      this.containerName = container.container_name // Show only container name in input
      this.selectedContainerName = container.container_name
      this.containerDescription = container.description // Keep description for display above table
